...
public class AnimActivity extends AppCompatActivity {
 ...
 //анимацинные ресурцы
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alphaDemo = AnimationUtils.loadAnimation(this , R.anim.alpha_demo);  //загружаем ету анимаци и нашего ресурса
        ...
        animationSet = new AnimationSet(true);  // (все анимации идут по одной кривой)
        animationSet.addAnimation(scaleDemo);
        animationSet.addAnimation(rotateDemo);
        bell = AnimationUtils.loadAnimation(this , R.anim.bell);
